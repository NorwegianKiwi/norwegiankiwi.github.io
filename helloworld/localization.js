...
const progressionMessages = Object.freeze({
  nb: Object.freeze({
    ...
    nextQuiz: "Neste quiz", nextResultMode: "Neste: {mode}", nextResultLevel: "Neste nivå", startResultLevel: "Start nivå {number}", startResultLevelAccessible: "Start nivå {number}: {title}", nextLevelAction: "Neste", congratulations: "Gratulerer!", tryAgainAction: "Prøv igjen", playAgain: "Spill igjen",
  ...
  en: Object.freeze({
    ...
    nextQuiz: "Next quiz", nextResultMode: "Next: {mode}", nextResultLevel: "Next level", startResultLevel: "Start level {number}", startResultLevelAccessible: "Start level {number}: {title}", nextLevelAction: "Next", congratulations: "Congratulations!", tryAgainAction: "Try again", playAgain: "Play again",
