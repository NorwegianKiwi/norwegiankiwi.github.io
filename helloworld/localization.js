...
const progressionMessages = Object.freeze({
  nb: Object.freeze({
    ...
    createProfile: "Opprett profil", updateProfile: "Oppdater {name}", mergeInto: "Slå sammen med {name}",
    ...
    nextQuiz: "Neste quiz", nextResultMode: "Neste: {mode}", nextQuizDestination: "{action}: Nivå {number} · {title} · {mode}", nextLevelAction: "Neste", congratulations: "Gratulerer!", tryAgainAction: "Prøv igjen",
  ...
  en: Object.freeze({
    ...
    createProfile: "Create profile", updateProfile: "Update {name}", mergeInto: "Merge with {name}",
    ...
    nextQuiz: "Next quiz", nextResultMode: "Next: {mode}", nextQuizDestination: "{action}: Level {number} · {title} · {mode}", nextLevelAction: "Next", congratulations: "Congratulations!", tryAgainAction: "Try again",
    ...
    reviewCards: "Review with flashcards",
