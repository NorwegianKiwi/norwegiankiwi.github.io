    ...
    return [
      {
        ...
        items: [
          ...
          { title: { nb: "Ikke mestret → neste nivå", en: "Not mastered → next level" }, description: { nb: "Prøv igjen er primær. Nivåmerket står foran navnet over Neste, og foran quiztypen i knappen.", en: "Try again is primary. The badge precedes the level name above Next and the quiz mode inside the button." }, params: { preview: "result-failed-next" } },
          ...
          {title: {nb: "Hopp til et annet nivå", en: "Skip to another level"}, description: {nb: "Perfekt resultat hopper til en quiz midt i neste nivå. Nivåmerke og navn vises over knappen; nivåmerke og quiztype vises i knappen.", en: "Perfect result skips to a quiz partway through the next level. Shows badge and level name above Next, with badge and mode inside."}, params: {preview: "result-skip-level"}},
