...
const countries = [
  ...
  { code: "bi", region: "africa", name: { nb: "Burundi", en: "Burundi" }, capital: { nb: "Gitega", en: "Gitega" }, note: { nb: "Gitega ble Burundis politiske hovedstad i 2019 og erstattet Bujumbura. Bujumbura er fortsatt landets største by og økonomiske hovedstad.", en: "Gitega became Burundi’s political capital in 2019, replacing Bujumbura. Bujumbura remains the country’s largest city and economic capital." } },
  ...
  { code: "ls", region: "africa", name: { nb: "Lesotho", en: "Lesotho" }, capital: { nb: "Maseru", en: "Maseru" }, note: { nb: "Lesotho er et selvstendig land som er helt omgitt av Sør-Afrika.", en: "Lesotho is an independent country entirely surrounded by South Africa." } },
  ...
  { code: "za", region: "africa", name: { nb: "Sør-Afrika", en: "South Africa" }, capital: { nb: "Pretoria / Cape Town / Bloemfontein", en: "Pretoria / Cape Town / Bloemfontein" } },
  ...
  { code: "af", region: "asia-east", name: { nb: "Afghanistan", en: "Afghanistan" }, capital: { nb: "Kabul", en: "Kabul" } },
  { code: "am", region: "asia-west", name: { nb: "Armenia", en: "Armenia" }, capital: { nb: "Jerevan", en: "Yerevan" } },
  { code: "az", region: "asia-west", name: { nb: "Aserbajdsjan", en: "Azerbaijan" }, capital: { nb: "Baku", en: "Baku" } },
  { code: "bh", region: "asia-west", name: { nb: "Bahrain", en: "Bahrain" }, capital: { nb: "Manama", en: "Manama" } },
  { code: "bd", region: "asia-east", name: { nb: "Bangladesh", en: "Bangladesh" }, capital: { nb: "Dhaka", en: "Dhaka" } },
  { code: "bt", region: "asia-east", name: { nb: "Bhutan", en: "Bhutan" }, capital: { nb: "Thimphu", en: "Thimphu" } },
  { code: "bn", region: "asia-east", name: { nb: "Brunei", en: "Brunei" }, capital: { nb: "Bandar Seri Begawan", en: "Bandar Seri Begawan" } },
  { code: "kh", region: "asia-east", name: { nb: "Kambodsja", en: "Cambodia" }, capital: { nb: "Phnom Penh", en: "Phnom Penh" } },
  { code: "cn", region: "asia-east", name: { nb: "Kina", en: "China" }, capital: { nb: "Beijing", en: "Beijing" } },
  { code: "cy", region: "asia-west", name: { nb: "Kypros", en: "Cyprus" }, capital: { nb: "Nikosia", en: "Nicosia" }, note: { nb: "FN plasserer Kypros i Vest-Asia i M49-inndelingen, mens landet har vært medlem av EU siden 2004.", en: "The UN places Cyprus in Western Asia in its M49 classification, while the country has been an EU member since 2004." } },
  { code: "ge", region: "asia-west", name: { nb: "Georgia", en: "Georgia" }, capital: { nb: "Tbilisi", en: "Tbilisi" } },
  { code: "in", region: "asia-east", name: { nb: "India", en: "India" }, capital: { nb: "New Delhi", en: "New Delhi" } },
  { code: "id", region: "asia-east", name: { nb: "Indonesia", en: "Indonesia" }, capital: { nb: "Jakarta", en: "Jakarta" } },
  { code: "ir", region: "asia-west", name: { nb: "Iran", en: "Iran" }, capital: { nb: "Teheran", en: "Tehran" } },
  { code: "iq", region: "asia-west", name: { nb: "Irak", en: "Iraq" }, capital: { nb: "Bagdad", en: "Baghdad" } },
  { code: "il", region: "asia-west", name: { nb: "Israel", en: "Israel" }, capital: { nb: "Jerusalem", en: "Jerusalem" } },
  { code: "jp", region: "asia-east", name: { nb: "Japan", en: "Japan" }, capital: { nb: "Tokyo", en: "Tokyo" } },
  { code: "jo", region: "asia-west", name: { nb: "Jordan", en: "Jordan" }, capital: { nb: "Amman", en: "Amman" } },
  { code: "kz", region: "asia-west", name: { nb: "Kasakhstan", en: "Kazakhstan" }, capital: { nb: "Astana", en: "Astana" } },
  { code: "kw", region: "asia-west", name: { nb: "Kuwait", en: "Kuwait" }, capital: { nb: "Kuwait by", en: "Kuwait City" } },
  { code: "kg", region: "asia-west", name: { nb: "Kirgisistan", en: "Kyrgyzstan" }, capital: { nb: "Bisjkek", en: "Bishkek" } },
  { code: "la", region: "asia-east", name: { nb: "Laos", en: "Laos" }, capital: { nb: "Vientiane", en: "Vientiane" } },
  { code: "lb", region: "asia-west", name: { nb: "Libanon", en: "Lebanon" }, capital: { nb: "Beirut", en: "Beirut" } },
  { code: "my", region: "asia-east", name: { nb: "Malaysia", en: "Malaysia" }, capital: { nb: "Kuala Lumpur", en: "Kuala Lumpur" } },
  { code: "mv", region: "asia-east", name: { nb: "Maldivene", en: "Maldives" }, capital: { nb: "Malé", en: "Malé" } },
  { code: "mn", region: "asia-east", name: { nb: "Mongolia", en: "Mongolia" }, capital: { nb: "Ulaanbaatar", en: "Ulaanbaatar" } },
  { code: "mm", region: "asia-east", name: { nb: "Myanmar", en: "Myanmar" }, capital: { nb: "Naypyidaw", en: "Naypyidaw" } },
  { code: "np", region: "asia-east", name: { nb: "Nepal", en: "Nepal" }, capital: { nb: "Katmandu", en: "Kathmandu" }, note: { nb: "Nepal har verdens eneste nasjonalflagg som ikke er rektangulært. Det består av to trekantede vimpler.", en: "Nepal has the world’s only national flag that is not rectangular. It consists of two triangular pennants." } },
  { code: "kp", region: "asia-east", name: { nb: "Nord-Korea", en: "North Korea" }, capital: { nb: "Pyongyang", en: "Pyongyang" } },
  { code: "om", region: "asia-west", name: { nb: "Oman", en: "Oman" }, capital: { nb: "Muskat", en: "Muscat" } },
  { code: "pk", region: "asia-east", name: { nb: "Pakistan", en: "Pakistan" }, capital: { nb: "Islamabad", en: "Islamabad" } },
  { code: "ps", region: "asia-west", name: { nb: "Palestina", en: "Palestine" }, capital: { nb: "Øst-Jerusalem / Ramallah", en: "East Jerusalem / Ramallah" } },
  { code: "ph", region: "asia-east", name: { nb: "Filippinene", en: "Philippines" }, capital: { nb: "Manila", en: "Manila" } },
  { code: "qa", region: "asia-west", name: { nb: "Qatar", en: "Qatar" }, capital: { nb: "Doha", en: "Doha" } },
  { code: "ru", region: "asia-east", name: { nb: "Russland", en: "Russia" }, capital: { nb: "Moskva", en: "Moscow" }, note: { nb: "Russland ligger i både Europa og Asia. I denne quizen er landet plassert i regionen Asia (øst) for å gi én tydelig regioninndeling. Både regionkartet og landformen viser hele Russland.", en: "Russia lies in both Europe and Asia. In this quiz it is placed in the Asia (East) region to provide one clear regional classification. Both the regional map and the country silhouette show the complete country." } },
  { code: "sa", region: "asia-west", name: { nb: "Saudi-Arabia", en: "Saudi Arabia" }, capital: { nb: "Riyadh", en: "Riyadh" } },
  { code: "sg", region: "asia-east", name: { nb: "Singapore", en: "Singapore" }, capital: { nb: "Singapore", en: "Singapore" } },
  { code: "kr", region: "asia-east", name: { nb: "Sør-Korea", en: "South Korea" }, capital: { nb: "Seoul", en: "Seoul" } },
  { code: "lk", region: "asia-east", name: { nb: "Sri Lanka", en: "Sri Lanka" }, capital: { nb: "Sri Jayawardenepura Kotte", en: "Sri Jayawardenepura Kotte" } },
  { code: "sy", region: "asia-west", name: { nb: "Syria", en: "Syria" }, capital: { nb: "Damaskus", en: "Damascus" } },
  { code: "tj", region: "asia-west", name: { nb: "Tadsjikistan", en: "Tajikistan" }, capital: { nb: "Dusjanbe", en: "Dushanbe" } },
  { code: "th", region: "asia-east", name: { nb: "Thailand", en: "Thailand" }, capital: { nb: "Bangkok", en: "Bangkok" } },
  { code: "tl", region: "asia-east", name: { nb: "Øst-Timor", en: "Timor-Leste" }, capital: { nb: "Dili", en: "Dili" } },
  { code: "tr", region: "asia-west", name: { nb: "Tyrkia", en: "Türkiye" }, capital: { nb: "Ankara", en: "Ankara" }, note: { nb: "Tyrkia ligger i både Asia og Europa. I denne quizen er landet plassert i Asia etter FNs M49-inndeling.", en: "Türkiye lies in both Asia and Europe. In this quiz it is placed in Asia in accordance with the UN M49 classification." } },
  { code: "tm", region: "asia-west", name: { nb: "Turkmenistan", en: "Turkmenistan" }, capital: { nb: "Asjkhabad", en: "Asjkhabad" } },
  { code: "ae", region: "asia-west", name: { nb: "De forente arabiske emirater", en: "United Arab Emirates" }, capital: { nb: "Abu Dhabi", en: "Abu Dhabi" } },
  { code: "uz", region: "asia-west", name: { nb: "Usbekistan", en: "Uzbekistan" }, capital: { nb: "Tasjkent", en: "Tashkent" } },
  { code: "vn", region: "asia-east", name: { nb: "Vietnam", en: "Vietnam" }, capital: { nb: "Hanoi", en: "Hanoi" } },
  { code: "ye", region: "asia-west", name: { nb: "Jemen", en: "Yemen" }, capital: { nb: "Sana", en: "Sana’a" } },
  ...
  { code: "tw", region: "asia-east", name: { nb: "Taiwan", en: "Taiwan" }, capital: { nb: "Taipei", en: "Taipei" } },
].map(defineCountry);
...
const otherPlaces = [
  ...
  { code: "eh", region: "africa", name: { nb: "Vest-Sahara", en: "Western Sahara" }, capital: { nb: "El Aaiún / Tifariti", en: "El Aaiún / Tifariti" }, status: { nb: "Omstridt territorium", en: "Disputed territory" }, note: { nb: "El Aaiún er det største administrative sentrumet. Saharawiske myndigheter regner Tifariti som en midlertidig hovedstad.", en: "El Aaiún is the largest administrative centre. Sahrawi authorities identify Tifariti as a temporary capital." } },
  { code: "re", region: "africa", name: { nb: "Réunion", en: "Réunion" }, capital: { nb: "Saint-Denis", en: "Saint-Denis" }, status: { nb: "Oversjøisk region i Frankrike", en: "Overseas region of France" }, relatedCountryCode: "fr", flagStatus: "established-local" },
  { code: "yt", region: "africa", name: { nb: "Mayotte", en: "Mayotte" }, capital: { nb: "Mamoudzou", en: "Mamoudzou" }, status: { nb: "Oversjøisk departement i Frankrike; kreves av Komorene", en: "Overseas department of France; claimed by Comoros" }, relatedCountryCode: "fr", flagStatus: "established-local" },
  { code: "hk", region: "asia-east", name: { nb: "Hongkong", en: "Hong Kong" }, capital: { nb: "Hongkong", en: "Hong Kong" }, status: { nb: "Spesiell administrativ region i Kina", en: "Special administrative region of China" }, relatedCountryCode: "cn" },
  { code: "mo", region: "asia-east", name: { nb: "Macao", en: "Macau" }, capital: { nb: "Macao", en: "Macau" }, status: { nb: "Spesiell administrativ region i Kina", en: "Special administrative region of China" }, relatedCountryCode: "cn" },
...
const regionOptions = [
  ...
  {
    id: "asia-west",
    label: { nb: "Asia (vest)", en: "Asia (West)" },
  },
  {
    id: "asia-east",
    label: { nb: "Asia (øst)", en: "Asia (East)" },
  },
